SELECT b.Codice_PNR, s_partenza.Nome_Stazione AS Stazione_Partenza, s_arrivo.Nome_Stazione AS Stazione_Arrivo, c.Data_Ora_Partenza, c.Data_Ora_Arrivo, p.Nome, p.Cognome
FROM Biglietti b
